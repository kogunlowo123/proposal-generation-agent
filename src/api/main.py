"""Proposal Generation Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Proposal generation agent that creates customized sales proposals, incorporates pricing configurations, adds case studies and social proof, manages proposal workflows, and tracks proposal engagement.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
