"""Proposal Generation Agent — Agent Orchestrator (Plan → Research → Execute → Validate → Respond)."""
...
class AgentOrchestrator:
    """Orchestrates the Proposal Generation Agent through a multi-step pipeline.
