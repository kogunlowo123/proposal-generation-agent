"""Proposal Generation Agent - Main Agent Implementation."""
...
class ProposalGenerationAgentAgent:
    """
    ...
    def __init__(self):
        ...
        self.proposal_enabled = True
        self.generation_enabled = True
        self.analytics_enabled = True
        self.automation_enabled = True
        self._tool_dispatch = {
            "generate_proposal": self.tools.generate_proposal,
            "configure_pricing": self.tools.configure_pricing,
            "add_case_studies": self.tools.add_case_studies,
            "send_proposal": self.tools.send_proposal,
            "track_proposal": self.tools.track_proposal,
        }
        logger.info(
            "agent_initialized",
            ...
            features=['proposal', 'generation', 'analytics', 'automation'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "add_case_studies": ['add', 'case', 'studies'],
            "send_proposal": ['send', 'proposal'],
            "track_proposal": ['track', 'proposal'],
        }
