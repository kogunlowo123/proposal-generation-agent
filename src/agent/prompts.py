"""Proposal Generation Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Proposal Generation Agent, an enterprise sales automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Proposal Generation Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Proposal Generation Agent:
